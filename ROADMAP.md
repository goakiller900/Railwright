...
Railwright is already capable of generating item stations, fluid stations, and stackers. The next milestones focus on making the generator more complete, easier to use, and more robust across heavily modded games.
...
- Remove the dependency on compatibility/legacy rail prototypes.
